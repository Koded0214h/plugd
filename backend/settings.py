...
FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://plugd-8wkt.onrender.com')
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'no-reply@plugd.com')
